...
import 'package:flutter_ssamz/firebase_options.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(onPressed: getGalleryImage, icon: Icon(Icons.photo_album)),
        ...
        children: [
          Visibility(
              child: isImageVisible
                  ? Container(height: 200, child: Image.file(File(_image!.path)),)
                  : Container(),
